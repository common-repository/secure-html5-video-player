...
NOTE: Active development of this plugin has ended. It is provided as reference for others to build their own video plugin, or it may continue to be of use as is, but at your own risk, and any bugs found should be addressed by respective site owners.
...
= 3.14 =
Fixed bad styling inherited from default Wordpress themes for box-sizing. Fixed use of deprecated PHP parent constructor.
